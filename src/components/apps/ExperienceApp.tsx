          ...
          <div key={`${job.company}-${job.period}`}>
            <article className="py-3">
              <div className="flex flex-wrap items-baseline justify-between gap-2">
                <h3 className="font-[family-name:var(--font-display)] text-[15px] font-semibold text-slate-900">
                  {job.company}
                </h3>
              ...
              <p className="mt-0.5 text-[12.5px] text-slate-600">{job.project}</p>
              ...
              {job.functions && job.functions.length > 0 && (
                <ul className="mt-2 list-disc space-y-1 pl-4 text-[12.5px] text-slate-700">
